...
GH_PAGES_REPO_FROM_SLUG="github.com/terrestris/geoserver-in-action-ws.git"
GH_PAGES_REPO="https://$GH_PAGES_REPO_FROM_SLUG"
GH_PAGES_REPO_AUTHENTICATED="https://$GHTOKEN@$GH_PAGES_REPO_FROM_SLUG"
GH_PAGES_DIR=/tmp/geoserver-in-action-ws-gh-pages
...
rm -Rf *.zip *.tar.gz *.pdf *.epub *.html *.json gitbook/ materials/ assets/ basics/ environment/ rest/ troubleshooting/
